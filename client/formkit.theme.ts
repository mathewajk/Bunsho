...
/**
  ...
  *
  * @checksum - 14e3e08d2a315223df663559d0f09d6c9101dd5e912c60f7dcc1765cab0b0dcd
  * @variables - radius=rounded-lg,accentColor=sky,colorTemperature=neutral,spacing=2.5,scale=base,inputShadow=shadow,baseColorShade=600,borderShadeLightMode=400,borderShadeDarkMode=500,inputMaxWidth=max-w-[20em],tagRadius=rounded,swatchRadius=rounded
  * @theme - regenesis
  **/
